...
-->	
     ...
     <h3>reputation</h3><br />
						 <span>歌手:&nbsp;&nbsp;&nbsp;&nbsp; <a>Taylor Swift</a> </span><br />
						 <span>发行时间:&nbsp;&nbsp;&nbsp;&nbsp; 2001-9-29</span><br />
						 <span>发行公司:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;环球唱片</span><br/><br>
			    ...
			    <h5 style="font-weight:bold;">专辑介绍:</h5>
...
压轴歌曲《手机》将听众的认同感升华，为我们展现了一段暖心的故事。智能手机颠覆了人们的生活，让我们的距离既亲密又疏离。聚会的时候，先自拍一下帮我记录我现在快乐的样子，然后再Po到社交媒体告诉大家我快乐的样子。手机也是记录我们快乐或悲伤的载体，而音乐是宣泄情绪的载体。这首歌特邀了立式贝斯手，配合金玟岐的词曲一同展现了音乐的张力。
			  ...
			  <div class="yllist" style="width: 90%;float: right;">
			  	<h4>&nbsp;</h4>
			  	<h3 style="font-weight:bold;">包含歌曲列表<small>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;4首歌</small></h3>
...
-->
            ...
            <div id="youbian" >
            	<span style="font-weight: bold;">Ta的其他热门专辑</span> <span id="quanbu"><a>全部</a></span>
            </div>
            <div style="border-top: 1px solid gray;"></div>
               	<span >&nbsp;</span>              
                   <ul>
            	<li>
            		...
            		<div id="tupianmingzi">
            			<span>&nbsp;&nbsp;&nbsp;&nbsp;reputation</span><br /><br />
            			<span id="tupian3-1">2017-11-2</span>
            		</div>
