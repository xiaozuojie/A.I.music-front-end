...
<img class="j-flag" title="${zhuanji.albumsName}" height="145px" width="150px" src="bootstrap/musicimage/mainpageimage/封面2.jpg">
<a title="${zhuanji.albumsName}" href="#" class="msk"></a>
...
<p class="dec">
<a title="${zhuanji.albumsName}" href="#" class="tit f-thide s-fc0">${zhuanji.albumsName}</a>
</p>
