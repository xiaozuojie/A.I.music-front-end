...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="bootstrap/Musiccss/tuijpage.css"/>
...
<div class="container">
	<div class="row clearfix">
		<div class="col-md-12 column" style=" width: 83%; height: 1600px;margin-top: 10px;">
			<div class="row clearfix">
      <!--
	作者：offline
	时间：2017-11-11
 ...
 <!-- 描述：横线   --> <div id="" style="border-top: 2px solid #D80000;margin-top: 40px;margin-right: 10px;"> </div>
			    ...
			    <div id="" style="height: 400px;margin-right: 10px;margin-top: 10px;">
			    <!--
                	作者：offline
                	时间：2017-11-12
                	描述：第一歌单开始
...
<!--
	...
	描述：榜单开始
-->
<div id="" style="height: 600px;width: 100%;border: 1px solid white;margin-top: 70px;">
	
<div  class="rementuijianbandan"  >
				<ul>
					<li><span class="glyphicon glyphicon-record" style="color: red;font-weight: 1000;"></span><a href="#" style="text-decoration: none;font-weight: 600; font-size: 17px;color: #202020;">榜单</a></li>
				</ul>
			    </div>
...
<div id="" style="height: 510px;background-color: rgb(245,245,245); margin-right: 10px;margin-top: 15px;border: 1px solid #E0E0E0;text-align: center;">
	<div id="" style="height: 500px;width: 49%; padding: 10px;float: left; margin-top: 15px;">
	   <div id="">
	   	 <img src="bootstrap/musicimage/mainpageimage/cover3.jpg"/>
	        <a href="" style="color:#696969; font-size: 14px;font-weight: 700;">A.I.爱音乐飙升榜</a>
	   </div>
	  <div id="" class="aibiaosheng">
	  <table class="table table-striped" style="margin-top: 40px; text-align: left; ">
   <tbody >
      <tr>
         <td>1</td>
         <td>火力全开</td>
    ...
    <div id="" style="height: 500px;width: 49%;float: left; padding: 10px; margin-top: 15px;">
	    <div id="">
	   	 <img src="bootstrap/musicimage/mainpageimage/cover2.jpg"/>
	         <a href="" style="color:#696969; font-size: 14px;font-weight: 700;">A.I.爱音乐新歌榜</a>
	   </div>
        <div id="">
